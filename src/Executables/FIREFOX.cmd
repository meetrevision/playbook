...
reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "Title" /t REG_SZ /d "Revision" /f >NUL 2>nul
reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "URL" /t REG_SZ /d "https://revi.cc/" /f >NUL 2>nul
reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "Favicon" /t REG_SZ /d "https://revi.cc/img/favicon.png" /f >NUL 2>nul
reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "Placement" /t REG_SZ /d "toolbar" /f >NUL 2>nul
reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\1" /v "Folder" /t REG_SZ /d "" /f >NUL 2>nul

reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "Title" /t REG_SZ /d "FAQ" /f >NUL 2>nul
reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "URL" /t REG_SZ /d "https://revi.cc/docs/faq/" /f >NUL 2>nul
reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "Favicon" /t REG_SZ /d "https://revi.cc/img/favicon.png" /f >NUL 2>nul
reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "Placement" /t REG_SZ /d "toolbar" /f >NUL 2>nul
reg add "HKU\%~1\Software\Policies\Mozilla\Firefox\Bookmarks\10" /v "Folder" /t REG_SZ /d "" /f >NUL 2>nul
