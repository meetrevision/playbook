...
[![Releases](https://img.shields.io/github/v/release/meetrevision/playbook.svg?label=Release)](https://github.com/meetrevision/playbook/releases)
[![Downloads](https://img.shields.io/github/downloads/meetrevision/playbook/total?label=Total%20downloads)](https://github.com/meetrevision/playbook/releases/latest)
...
1. Ensure you have a fresh installation of Windows. We discourage applying the playbook on top of "established" Windows installations, i.e., those used for a long time with lots of software and user data.
2. Download [AME Wizard](https://ameliorated.io) and our playbook from the latest [releases](https://github.com/meetrevision/playbook/releases).
3. Launch the AME Wizard and drag-and-drop the playbook into the interface.
4. Follow the on-screen instructions to complete the installation.

> **Note:** It's recommended to start with a fresh, stock Windows installation before applying the playbook to avoid potential conflicts with existing software and user data.
