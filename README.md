...
ReviOS is a customized version of Windows, designed to be lightweight, stable, and focused on improving performance, privacy and compatibility. It aspires to re-create what Windows as an operating system should have been - easy and simple. Now compatible with [AME Beta](https://ameliorated.io)🧙.
...
2. Launch the AME Beta and drag-and-drop the playbook into the interface.
